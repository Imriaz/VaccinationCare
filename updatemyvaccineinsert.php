<?php
        ...
        $sql = "UPDATE vaccinelist SET id = 'NULL', vaccine_Name = '$Namvaccine_Name', age_Group = '$age_Group', 
        vaccine_Dose = '$vaccine_Dose', description = '$description', image = '$image' WHERE vaccine_Name = '$Namvaccine_Name'";
